...
import { ContactLink } from "@/app/cv-builder/_components/preview/contact-link";
...
import type { PhotoBlockProps, PreviewSidebarProps } from "@/models/cv-builder";

function PhotoBlock({ photo, fullName }: PhotoBlockProps) {
  return (
